define({
  bmp: {
    file: [
      {
        "file(0-69)": "sprite/banteg_0.png", w: 79, h: 79, row: 10, col: 7
      },
      {
        "file(70-139)": "sprite/banteg_1.png", w: 79, h: 79, row: 10, col: 7
      },
      {
        "file(140-209)": "sprite/banteg_3.png", w: 79, h: 79, row: 10, col: 7
      },
      {
        "file(210-213)": "sprite/banteg_2.png", w: 109, h: 109, row: 4, col: 1
      }
    ],
    name: "Banteg",
    head: "sprite/banteg_f.png",
    small: "sprite/banteg_s.png",
  ...
  241: { name: "DAA_action2",
    ...
    opoint: {
      kind: 1, x: 95, y: 78, action: 0, dvx: 0, dvy: 0, oid: 270, facing: 0
    },
    wpoint: {
  ...
  255: { name: "heal_self",
    ...
    opoint: {
      kind: 1, x: 40, y: 39, action: 40, dvx: 0, dvy: 0, oid: 270, facing: 0
    },
    wpoint: {
  ...
  265: { name: "heal_other",
    ...
    opoint: {
      kind: 1, x: 78, y: 36, action: 50, dvx: 0, dvy: 0, oid: 270, facing: 0
    },
    wpoint: {
  ...
  278: { name: "force_field",
    ...
    opoint: {
      kind: 1, x: 73, y: 40, action: 60, dvx: 0, dvy: 0, oid: 270, facing: 0
    },
    wpoint: {
  ...
  302: { name: "biscuit",
    ...
    sound: "1/075",
    opoint: {
      kind: 1, x: 18, y: 26, action: 40, dvx: 0, dvy: 0, oid: 271, facing: 0
    },
    wpoint: {
