define({
  bmp: {
    file: [
      {
        "file(0-69)": "sprite/hayden_0.png", w: 79, h: 79, row: 10, col: 7
      },
      {
        "file(70-139)": "sprite/hayden_1.png", w: 79, h: 79, row: 10, col: 7
      },
      {
        "file(140-209)": "sprite/hayden_2.png", w: 79, h: 79, row: 10, col: 7
      }
    ],
    name: "Henry",
    head: "sprite/hayden_f.png",
    small: "sprite/hayden_s.png",
  ...
  64: { name: "punch",
    ...
    sound: "1/024",
    opoint: {
      kind: 1, x: 95, y: 57, action: 40, dvx: 22, dvy: -3, oid: 263, facing: 0
    },
    bdy: [
      {
  ...
  84: { name: "jump_attack",
    ...
    sound: "1/024",
    opoint: {
      kind: 1, x: 80, y: 77, action: 44, dvx: 12, dvy: 9, oid: 263, facing: 0
    },
    bdy: {
  ...
  239: { name: "blastpush",
    ...
    sound: "1/020",
    opoint: {
      kind: 1, x: 83, y: 44, action: 20, dvx: -5, dvy: 0, oid: 262, facing: 1
    },
    wpoint: {
      kind: 1, x: 28, y: 48, weaponact: 30, attacking: 0, cover: 1, dvx: 0, dvy: 0, dvz: 0
    },
  ...
  240: { name: "blastpush",
    ...
    opoint: {
      kind: 1, x: 73, y: 44, action: 0, dvx: 0, dvy: 0, oid: 262, facing: 0
    },
    wpoint: {
  ...
  277: { name: "super_arrow",
    ...
    sound: "1/024",
    opoint: {
      kind: 1, x: 95, y: 41, action: 0, dvx: 22, dvy: 0, oid: 264, facing: 0
    },
    wpoint: {
      kind: 1, x: 39, y: 48, weaponact: 30, attacking: 0, cover: 1, dvx: 0, dvy: 0, dvz: 0
    },
  ...
  286: { name: "5_arrow",
    ...
    opoint: {
      kind: 1, x: 95, y: 57, action: 141, dvx: 22, dvy: -3, oid: 263, facing: 50
    },
    wpoint: {
