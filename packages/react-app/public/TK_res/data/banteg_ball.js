define({
  bmp: {
    file: [
      {
        "file(0-23)": "sprite/banteg_ball.png", w: 81, h: 82, row: 8, col: 6
      }
    ],
  ...
  31: { name: "rebounding",
    ...
    opoint: {
      kind: 1, x: 19, y: 41, action: 0, dvx: 0, dvy: 0, oid: 270, facing: 1
    }
  },
  32: { name: "rebounding",
  ...
  41: { name: "stars",
    ...
    opoint: {
      kind: 1, x: 40, y: 39, action: 44, dvx: 0, dvy: 0, oid: 270, facing: 0
    }
  },
  42: { name: "stars",
  ...
  51: { name: "healball",
    ...
    opoint: {
      kind: 1, x: 40, y: 39, action: 42, dvx: 0, dvy: 0, oid: 270, facing: 0
    },
    itr: {
      kind: 8, x: 25, y: 13, w: 32, h: 34, dvx: 40, injury: 100
    }
