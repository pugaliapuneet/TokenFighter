define({
  bmp: {
    file: [
      {
        "file(0-49)": "sprite/arthur_0.png", w: 79, h: 99, row: 10, col: 5
      },
      {
        "file(50-63)": "sprite/arthur_1.png", w: 109, h: 99, row: 7, col: 2
      },
      {
        "file(64-113)": "sprite/arthur_2.png", w: 79, h: 99, row: 10, col: 5
      }
    ],
    name: "Arthur",
    head: "sprite/arthur_f.png",
    small: "sprite/arthur_s.png",
  ...
  103: { name: "rowing",
    ...
    opoint: {
      kind: 1, x: 39, y: 99, action: 240, dvx: 0, dvy: 0, oid: 62, facing: 0
    },
    wpoint: {
      kind: 1, x: 28, y: 60, weaponact: 31, attacking: 0, cover: 1, dvx: 0, dvy: 0, dvz: 0
    }
  ...
  261: { name: "ball",
    ...
    sound: "1/091",
    opoint: {
      kind: 1, x: 60, y: 50, action: 100, dvx: 15, dvy: 0, oid: 260, facing: 0
    },
    wpoint: {
      kind: 1, x: 41, y: 59, weaponact: 30, attacking: 0, cover: 1, dvx: 0, dvy: 0, dvz: 0
    },
  ...
  289: { name: "big_ball",
    ...
    sound: "1/019",
    opoint: {
      kind: 1, x: 90, y: 50, action: 0, dvx: 15, dvy: 0, oid: 261, facing: 0
    },
    wpoint: {
      kind: 1, x: 34, y: 62, weaponact: 31, attacking: 0, cover: 1, dvx: 0, dvy: 0, dvz: 0
    },
  ...
  318: { name: "explosion",
    ...
    opoint: {
      kind: 1, x: 40, y: 100, action: 40, dvx: 0, dvy: 0, oid: 261, facing: 0
    },
    wpoint: {
      kind: 1, x: 35, y: 62, weaponact: 30, attacking: 0, cover: 1, dvx: 0, dvy: 0, dvz: 0
    },
