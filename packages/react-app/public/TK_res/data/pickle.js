define({
  bmp: {
    file: [
      {
        "file(0-69)": "sprite/pickle_0.png", w: 79, h: 79, row: 10, col: 7
      },
      {
        "file(70-139)": "sprite/pickle_1.png", w: 79, h: 79, row: 10, col: 7
      }
      // {
    ...
    name: "Pickle",
    head: "sprite/pickle_f.png",
    small: "sprite/pickle_s.png",
  ...
  244: { name: "ball1",
    ...
    opoint: {
      kind: 1, x: 80, y: 36, action: 0, dvx: 0, dvy: 0, oid: 276, facing: 0
    },
    wpoint: {
      kind: 1, x: 40, y: 50, weaponact: 30, attacking: 0, cover: 1, dvx: 0, dvy: 0, dvz: 0
    },
