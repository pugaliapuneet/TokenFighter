define({
  bmp: {
    file: [
      {
        "file(0-69)": "sprite/msbtc_0.png", w: 79, h: 79, row: 10, col: 7
      },
      {
        "file(70-139)": "sprite/msbtc_1.png", w: 79, h: 79, row: 10, col: 7
      },
      {
        "file(140-149)": "sprite/msbtc_2.png", w: 149, h: 87, row: 5, col: 2
      },
      {
        "file(150-155)": "sprite/msbtc_3.png", w: 94, h: 64, row: 6, col: 1
      }
    ],
    name: "Mai",
    head: "sprite/msbtc_f.png",
    small: "sprite/msbtc_s.png",
  ...
  62: { name: "punch",
    ...
    opoint: {
      kind: 1, x: 75, y: 57, action: 40, dvx: 19, dvy: -3, oid: 272, facing: 0
    },
    bdy: {
  ...
  66: { name: "punch",
    ...
    opoint: {
      kind: 1, x: 75, y: 57, action: 40, dvx: 18, dvy: -2, oid: 272, facing: 0
    },
    bdy: {
  ...
  69: { name: "punch",
    ...
    opoint: {
      kind: 1, x: 75, y: 57, action: 40, dvx: 17, dvy: -1, oid: 272, facing: 0
    },
    bdy: {
  ...
  238: { name: "transform",
    ...
    sound: "1/061",
    opoint: {
      kind: 1, x: 41, y: 70, action: 70, dvx: 0, dvy: 0, oid: 273, facing: 0
    },
    cpoint: {
      kind: 1, x: 61, y: 39, vaction: 130, throwvz: -842150451, hurtable: 1, throwinjury: -842150451
    },
  ...
  256: { name: "disappear",
    ...
    opoint: {
      kind: 1, x: 41, y: 70, action: 60, dvx: 0, dvy: 0, oid: 273, facing: 0
    },
    wpoint: {
      kind: 1, x: 46, y: 49, weaponact: 30, attacking: 0, cover: 1, dvx: 0, dvy: 0, dvz: 0
    },
  ...
  271: { name: "+man",
    ...
    opoint: {
      kind: 1, x: 40, y: 79, action: 0, dvx: 0, dvy: 0, oid: 70, facing: 20
    },
    wpoint: {
      kind: 1, x: 46, y: 49, weaponact: 30, attacking: 0, cover: 1, dvx: 0, dvy: 0, dvz: 0
    },
  ...
  288: { name: "punch",
    ...
    opoint: {
      kind: 1, x: 75, y: 57, action: 40, dvx: 17, dvy: -3, oid: 272, facing: 50
    },
    wpoint: {
      kind: 1, x: 46, y: 51, weaponact: 31, attacking: 0, cover: 1, dvx: 0, dvy: 0, dvz: 0
    },
