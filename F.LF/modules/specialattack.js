...
define(['F.LF/modules/livingobject','F.LF/modules/global','F.LF/core/util'],
				...
				*/
				...
				if( $.frame.D.hit_Fa===13) {
					if ($.trans.wait() === 0) {
						...
						// Create julian ball
						var ball_opoint = {
							kind: 1, x: 60, y: 50, action: 0, dvx: 15, dvy: 0, oid: oid, facing: 0
						};
