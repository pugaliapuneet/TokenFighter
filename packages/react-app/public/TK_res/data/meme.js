define({
  bmp: {
    file: [
      {
        "file(0-69)": "sprite/meme_0.png", w: 79, h: 79, row: 10, col: 7
      },
      {
        "file(70-139)": "sprite/meme_1.png", w: 79, h: 79, row: 10, col: 7
      },
      {
        "file(140-209)": "sprite/meme_2.png", w: 79, h: 79, row: 10, col: 7
      }
    ],
    name: "MemeBoi",
    head: "sprite/meme_f.png",
    small: "sprite/meme_s.png",
  ...
  244: { name: "ball1",
    ...
    opoint: {
      kind: 1, x: 90, y: 43, action: 0, dvx: 0, dvy: 0, oid: 269, facing: 0
    },
    wpoint: {
  ...
  250: { name: "ball2",
    ...
    opoint: {
      kind: 1, x: 90, y: 40, action: 60, dvx: 0, dvy: 0, oid: 269, facing: 0
    },
    wpoint: {
  ...
  261: { name: "ball4",
    ...
    opoint: {
      kind: 1, x: 90, y: 48, action: 50, dvx: 0, dvy: 0, oid: 269, facing: 0
    },
    wpoint: {
