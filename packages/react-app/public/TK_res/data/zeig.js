define({
  bmp: {
    file: [
      {
        "file(0-69)": "sprite/zeig_0.png", w: 79, h: 79, row: 10, col: 7
      },
      {
        "file(70-139)": "sprite/zeig_1.png", w: 79, h: 79, row: 10, col: 7
      }
      // {
    ...
    name: "Lord Zeig",
    head: "sprite/zeig_f.png",
    small: "sprite/zeig_s.png",
  ...
  252: { name: "ball",
    ...
    opoint: {
      kind: 1, x: 80, y: 36, action: 0, dvx: 0, dvy: 0, oid: 277, facing: 0
    },
    wpoint: {
