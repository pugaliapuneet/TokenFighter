...
define(['F.LF/modules/loader-config','F.LF/modules/util','F.LF/core/util'],function(loader_config,util,Futil){
	...
	return {
		load: function (name, require, load, config)
		{
			...
			function load_package(pack)
			{
				...
				require( [filepath('manifest.js?v=0.1.2-10')], function(mani)
				{
					manifest=mani;
					var manifest_schema=
					{
